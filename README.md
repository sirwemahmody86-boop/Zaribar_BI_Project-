...
---نکته روش‌شناختی: شاخص‌های مربوط به آب بر پایه بازه کامل ۲۰۱۳ تا ۲۰۲۵ (Landsat 8 + Sentinel-2) محاسبه شده‌اند، در حالی‌که شاخص‌های نیزار از سال ۲۰۱۷ آغاز می‌شوند — چون استخراج قابل‌اتکای پوشش نیزار به وضوح مکانی ۱۰ متری Sentinel-2 نیاز دارد که پوشش پایدارش برای این منطقه از ۲۰۱۷ در دسترس است.
...
**توسعه‌دهنده:** ژوان محمودی (Jiwan Mahmody) — طراح و تحلیل‌گر داده‌های مکانی و هوش تجاری
